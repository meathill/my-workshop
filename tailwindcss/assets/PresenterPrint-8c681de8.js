import{d as _,u as d,a as p,c as m,b as h,r as u,e as n,f as t,t as s,g as a,F as f,h as g,n as v,i as y,o as r,j as x,k as b,l as k,m as w,_ as N}from"./index-577de66e.js";import{N as P}from"./NoteDisplay-6d43fbd0.js";const V={class:"m-4"},L={class:"mb-10"},S={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},B={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},C=_({__name:"PresenterPrint",setup(F){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
